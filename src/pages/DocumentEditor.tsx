  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa]" onKeyDown={handleKeyDown}>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-1">
              <Input
                ...
                className="text-xl font-normal border-none bg-transparent hover:bg-gray-50 focus:bg-white focus:border-blue-500 px-2 py-1 rounded-sm max-w-md"
      ...
      <div className="relative min-h-screen pt-32 bg-[#f8f9fa]">
        ...
        <div className="w-80 bg-white border-r border-gray-200 fixed top-32 bottom-0 left-6 overflow-y-auto">
          <div className="p-4">
            <Button 
              variant="ghost" 
              size="icon" 
